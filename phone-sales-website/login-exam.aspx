<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="login-exam.aspx.cs" Inherits="phone_sales_website.login_exam" %>
...
<%--                <div class="form-item">
            ...
            <input type="checkbox" name="like" value="Bong chuyen" class="checkbox-like" />Bong chuyen
                ...
                <div class="login">
                    ...
                    <a href="./sign-up-exam.aspx">Sign up</a>
                </div>
            </div>
        </div>
    </form>
    <%--<script src="./assets/js/lo"></script>--%>
</body>
</html>
</html>
